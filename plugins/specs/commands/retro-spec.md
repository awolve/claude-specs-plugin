...
Create `design.md` documenting what was built — architecture, components, key decisions. Follow the same format as `/spec design` but written in past tense (what was built, not what will be built).
